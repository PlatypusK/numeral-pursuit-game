...
public class Gameserver extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GameServerEndpoint {
     ...
     * @return the request
     */
    public FetchFinishedGames fetchFinishedGames() throws java.io.IOException {
      FetchFinishedGames result = new FetchFinishedGames();
      initialize(result);
      return result;
    }
    ...
    public class FetchFinishedGames extends GameserverRequest<com.appspot.numeralpursuit.gameserver.model.GameInfoCollection> {
       ...
       * @since 1.13
       */
      protected FetchFinishedGames() {
        super(Gameserver.this, "POST", REST_PATH, null, com.appspot.numeralpursuit.gameserver.model.GameInfoCollection.class);
      }
    ...
    /**
     * Create a request for the method "gameServerEndpoint.registerGCMId".
     *
     * This request holds the parameters needed by the the gameserver server.  After setting any
     * optional parameters, call the {@link RegisterGCMId#execute()} method to invoke the remote
     * operation.
     *
     * @param content the {@link com.appspot.numeralpursuit.gameserver.model.RegIdCGM}
     * @return the request
     */
    public RegisterGCMId registerGCMId(com.appspot.numeralpursuit.gameserver.model.RegIdCGM content) throws java.io.IOException {
      RegisterGCMId result = new RegisterGCMId(content);
      initialize(result);
      return result;
    }

    public class RegisterGCMId extends GameserverRequest<com.appspot.numeralpursuit.gameserver.model.SuccessCode> {

      private static final String REST_PATH = "registerGCMId";
       ...
       * This request holds the parameters needed by the the gameserver server.  After setting any
       * optional parameters, call the {@link RegisterGCMId#execute()} method to invoke the remote
       * operation. <p> {@link RegisterGCMId#initialize(com.google.api.client.googleapis.services.Abstra
       * ctGoogleClientRequest)} must be called to initialize this instance immediately after invoking
       * the constructor. </p>
       *
       * @param content the {@link com.appspot.numeralpursuit.gameserver.model.RegIdCGM}
       * @since 1.13
       */
      protected RegisterGCMId(com.appspot.numeralpursuit.gameserver.model.RegIdCGM content) {
        super(Gameserver.this, "POST", REST_PATH, content, com.appspot.numeralpursuit.gameserver.model.SuccessCode.class);
      }

      @Override
      public RegisterGCMId setAlt(java.lang.String alt) {
        return (RegisterGCMId) super.setAlt(alt);
      }

      @Override
      public RegisterGCMId setFields(java.lang.String fields) {
        return (RegisterGCMId) super.setFields(fields);
      }

      @Override
      public RegisterGCMId setKey(java.lang.String key) {
        return (RegisterGCMId) super.setKey(key);
      }

      @Override
      public RegisterGCMId setOauthToken(java.lang.String oauthToken) {
        return (RegisterGCMId) super.setOauthToken(oauthToken);
      }

      @Override
      public RegisterGCMId setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (RegisterGCMId) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public RegisterGCMId setQuotaUser(java.lang.String quotaUser) {
        return (RegisterGCMId) super.setQuotaUser(quotaUser);
      }

      @Override
      public RegisterGCMId setUserIp(java.lang.String userIp) {
        return (RegisterGCMId) super.setUserIp(userIp);
      }

      @Override
      public RegisterGCMId set(String parameterName, Object value) {
        return (RegisterGCMId) super.set(parameterName, value);
      }
    }
    /**
